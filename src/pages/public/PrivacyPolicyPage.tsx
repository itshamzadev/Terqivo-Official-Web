...
export default function PrivacyPolicyPage() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    apiFetch('/api/public/page/privacy-policy')
  ...
  if (loading) {
    return (
      ...
      <SEO title="Privacy Policy | TERQIVO" />
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 relative overflow-hidden bg-background">
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/5 blur-[150px] rounded-full pointer-events-none -translate-x-1/2 -translate-y-1/4" />
        ...
        >
          ...
          {content?.content ? (
            ...
            <div className="text-muted-foreground bg-secondary/10 border border-border border-dashed p-12 rounded-3xl text-center mt-12">
              ...
              <br/>Please configure the "privacy-policy" page content in the admin panel.
            </div>
          )}
        </motion.div>
      </div>
