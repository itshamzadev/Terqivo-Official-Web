  ...
  const steps = [
    {
      num: "01",
      title: "Apply",
      desc: "Submit your profile for an available role."
    },
    {
      num: "02",
      title: "Review",
      desc: "The team evaluates relevant skills and experience."
    },
    {
      num: "03",
      title: "Conversation",
      desc: "Discuss the role, goals, expectations, and mutual fit."
    },
    {
      num: "04",
      title: "Practical Evaluation",
      desc: "Complete a role-appropriate technical or practical assessment when needed."
    },
    {
      num: "05",
      title: "Decision",
      desc: "Receive a clear outcome and next steps."
    }
  ];
    ...
    <section className="py-24 bg-primary text-primary-foreground border-b border-primary/20 relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-7xl">
        <div className="mb-16">
          ...
          >
            A clear and respectful hiring process.
          </motion.h2>
        </div>
