  ...
  const principles = [
    {
      ...
      desc: "Delivering polished, high-fidelity software experiences."
    },
    {
      icon: Zap,
      title: "Performance",
      desc: "Optimizing every layer for maximum speed and efficiency."
    },
    {
      icon: Lock,
      title: "Security",
      desc: "Protecting data through rigorous defense-in-depth strategies."
    },
    {
      icon: Settings2,
      title: "Maintainability",
      desc: "Writing clean, self-documenting code that teams love to work with."
    },
    {
      icon: Activity,
      title: "Reliability",
      desc: "Ensuring maximum uptime through resilient architectural patterns."
    },
    {
      icon: TrendingUp,
      title: "Continuous Improvement",
      desc: "Iterating relentlessly based on metrics, feedback, and learning."
    }
  ];
    ...
    <section className="py-24 bg-background border-y">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground">The standards we hold ourselves to in every project.</p>
        </div>
