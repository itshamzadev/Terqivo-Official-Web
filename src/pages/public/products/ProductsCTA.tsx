  ...
  return (
    <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
        <h2 className="text-4xl md:text-5xl font-heading font-bold mb-6">Follow what Terqivo is building.</h2>
        <p className="text-xl text-primary-foreground/80 leading-relaxed mx-auto mb-10 max-w-2xl">
          Explore current products, follow development updates, and discover new software as it becomes available.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button size="lg" variant="secondary" className="h-14 px-10 text-base shadow-sm" asChild>
            <Link to="/contact">View Product Updates <ArrowUpRight className="ml-2 h-5 w-5" /></Link>
          </Button>
