...
export function ProductLifecycle() {
  ...
  const stages = [
    { 
      num: "01", 
      title: "Discover", 
      desc: "Understand the problem and intended users." 
    },
    { 
      num: "02", 
      title: "Define", 
      desc: "Shape the experience, architecture, and product boundaries." 
    },
    { 
      num: "03", 
      title: "Build", 
      desc: "Engineer reliable, maintainable software." 
    },
    { 
      num: "04", 
      title: "Release", 
      desc: "Deliver controlled versions with clear product states." 
    },
    { 
      num: "05", 
      title: "Improve", 
      desc: "Refine through feedback, learning, and future development." 
    }
  ];
    ...
    <section className="py-24 bg-primary text-primary-foreground border-y border-primary-foreground/10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mb-16 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">From product idea to continuous improvement.</h2>
        </div>
