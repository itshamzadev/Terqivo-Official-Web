...
import heroImg from '@/src/assets/images/products-hero.png';
...
export function ProductsHeroVisual() {
  return (
    <div className="w-full aspect-[4/3] rounded-[24px] shadow-2xl border bg-muted/20 flex flex-col items-center justify-center overflow-hidden">
      <ProgressiveImage
        src={heroImg}
        alt="Terqivo product ecosystem illustration"
        loading="eager"
        fetchPriority="high"
...
export function ProductsHero() {
  const scrollToProducts = () => {
    document.getElementById('dynamic-products')?.scrollIntoView({ behavior: 'smooth' });
  };
          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold tracking-tight text-foreground leading-[1.1]">
                Intelligent products designed for meaningful work.
              </h1>
              <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-lg font-sans">
                Terqivo develops AI-powered software, desktop tools, secure platforms, and connected digital products designed to make technology more practical and useful.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
              <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-base shadow-sm" onClick={scrollToProducts}>
                Explore Products <ArrowDown className="ml-2 h-5 w-5" />
              </Button>
            ...
            <p className="text-sm text-muted-foreground font-medium pt-4">
              Built with product thinking, secure engineering, and long-term improvement.
            </p>
          </motion.div>
