...
export function SolutionApproach() {
  ...
  const stages = [
    { 
      num: "01", 
      title: "Understand", 
      desc: "Clarify the problem, users, workflows, and technical constraints." 
    },
    { 
      num: "02", 
      title: "Architect", 
      desc: "Define the product structure, data flow, integrations, and security model." 
    },
    { 
      num: "03", 
      title: "Engineer", 
      desc: "Build maintainable software with clear responsibilities and scalable foundations." 
    },
    { 
      num: "04", 
      title: "Validate", 
      desc: "Test usability, reliability, performance, and security behavior." 
    },
    { 
      num: "05", 
      title: "Evolve", 
      desc: "Improve the system through feedback, learning, and long-term maintenance." 
    }
  ];
    ...
    <section className="py-24 bg-primary text-primary-foreground border-y border-primary-foreground/10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mb-16 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">From a challenge to a dependable system.</h2>
          <p className="text-lg text-primary-foreground/70">
            Terqivo's approach to delivering functional, secure, and enduring solutions.
          </p>
        </div>
